...
from pyLiDAR_SLAM.slam.common.pose import Pose
...
class _WLSScheme(ABC):
    ...
    def __call__(self, residuals: torch.Tensor, **kwargs):
        ...
        """
        # -- ME -- Returns a new Tensor, detached from the current graph.
        # -- ME -- The result will never require gradient.
    ...
    def weights(self, residuals: torch.Tensor, **kwargs) -> torch.Tensor:
        ...
        """
        # -- ME -- Clamps all elements in input into the range [ min, max ]
