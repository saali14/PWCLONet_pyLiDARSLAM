...
# ABC: the infrastructure for defining abstract base classes
...
class Initialization(ABC):
    ...
    def init(self):
        ...
        # the NotImplementedError is a non-fatal error that occurs when
        # an abstract method lacks the required derived class to override this method
