...
# Project Imports
from pyLiDAR_SLAM.slam.models._resnet   import ResNetEncoder
from pyLiDAR_SLAM.slam.models.layers    import ACTIVATIONS
...
class PoseResNet(nn.Module):
    ...
    def forward(self, frames) -> torch.Tensor:
        if isinstance(frames, list):
            ...
            frames = frames[0]
        # -- ME -- frames are range images of shape (B, sequence_len, C, H, W)
